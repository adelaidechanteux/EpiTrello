...
class Task(models.Model):
    ...
    color = models.CharField(max_length=COLOR_LENGTH, default=COLOR_CHOICE)
...
class Board(models.Model):
    ...
    tasks = OrderedManyToManyField(
        to=Task, related_name="board_tasks_set", through="BoardTasksThroughModel"
    )
    #
